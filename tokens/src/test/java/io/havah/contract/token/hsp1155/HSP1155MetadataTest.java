...
public class HSP1155MetadataTest extends MultiTokenTest {
    ...
    void testTransferSingle() {
        ...
        */
        ...
        assertEquals(from.getValue(), HSP1155Basic.ZERO_ADDRESS);
    ...
    void testTokenURI() {
        BigInteger supply = BigInteger.valueOf(100);
        BigInteger newId = mintToken(supply);
        String uri = (String) score.call("uri", newId);
    ...
    void testSetTokenURI() {
        ...
        String newURI = ((String) score.call("uri", newId)) + "_updated";
        ...
        */
        ...
        // Check updated URI
        assertEquals(score.call("uri", newId), newURI);
    }
