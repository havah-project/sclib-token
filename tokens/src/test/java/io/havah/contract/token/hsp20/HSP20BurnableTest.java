...
public class HSP20BurnableTest extends TestBase {
    ...
    public static class HSP20BurnableToken extends HSP20Burnable {
        public HSP20BurnableToken(String _name, String _symbol, int _decimals, BigInteger _totalSupply) {
