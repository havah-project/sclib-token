...
public class HSP1155TransferTest extends MultiTokenTest {
    ...
    void testTransferFromZeroAddress() {
        ...
        assertThrows(AssertionError.class, () ->
                score.invoke(alice, "safeTransferFrom",
                        alice.getAddress(),
                        HSP1155Basic.ZERO_ADDRESS,
                        newId,
                        supply,
                        "test".getBytes()));
    }
    ...
    void testTransferFromTooMuch() {
        ...
        // transfer ownership
        assertThrows(AssertionError.class, () ->
                score.invoke(owner, "safeTransferFrom",
                        owner.getAddress(),
                        alice.getAddress(),
                        newId,
    ...
    void safeBatchTransferFrom() {
        ...
        score.invoke(owner, "safeBatchTransferFrom", owner.getAddress(), alice.getAddress(), ids, values, "test".getBytes());
        ...
        assertThrows(AssertionError.class, () ->
                score.invoke(owner, "safeBatchTransferFrom", alice.getAddress(), bob.getAddress(), ids, values2, "test".getBytes()));
    ...
    void testTransferFromBatchZeroAddress() {
        ...
        assertThrows(AssertionError.class, () ->
                score.invoke(owner, "safeBatchTransferFrom", owner.getAddress(), HSP1155Basic.ZERO_ADDRESS, ids, values, "test".getBytes()));
    }
