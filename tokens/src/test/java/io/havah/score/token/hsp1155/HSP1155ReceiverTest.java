...
public class HSP1155ReceiverTest extends TestBase {
    ...
    protected static HSP1155SampleReceiver spyRcv;

    protected static Score scoreToken;
    protected static HSP1155SampleToken spyToken;

    void receiverSetup() throws Exception {
        scoreRcv = sm.deploy(owner, HSP1155SampleReceiver.class);
        spyRcv = (HSP1155SampleReceiver) spy(scoreRcv.getInstance());
        scoreRcv.setInstance(spyRcv);
    }

    void tokenSetup() throws Exception {
        scoreToken = sm.deploy(owner, HSP1155SampleToken.class);
        spyToken = (HSP1155SampleToken) spy(scoreToken.getInstance());
    ...
    void testOnReceived() {
        ...
        scoreRcv.invoke(owner, "setOriginator", scoreToken.getAddress(), true);
        scoreToken.invoke(owner, "safeTransferFrom",
    ...
    void testOnBatchReceived() {
        ...
        scoreRcv.invoke(owner, "setOriginator", scoreToken.getAddress(), true);
        scoreToken.invoke(owner, "safeBatchTransferFrom",
