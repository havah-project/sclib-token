...
public class HSP20MintableTest extends TestBase {
    private static final String name = "MyHSP20Mintable";
    ...
    private static HSP20MintableToken tokenSpy;

    public static class HSP20MintableToken extends HSP20Mintable {
        public HSP20MintableToken(String _name, String _symbol, int _decimals, BigInteger _totalSupply) {
    ...
    public static void setup() throws Exception {
        tokenScore = sm.deploy(owner, HSP20MintableToken.class,
                name, symbol, decimals, totalSupply);
        owner.addBalance(symbol, totalSupply);

        // setup spy object against the tokenScore object
        tokenSpy = (HSP20MintableToken) spy(tokenScore.getInstance());
    ...
    void mint() {
        ...
        assertEquals(totalSupply, tokenScore.call("totalSupply"));
        verify(tokenSpy).Transfer(zeroAddress, owner.getAddress(), amount);
    }
    ...
    void mintToAlice() {
        ...
        assertEquals(totalSupply, tokenScore.call("totalSupply"));
        verify(tokenSpy).Transfer(zeroAddress, alice.getAddress(), amount);
    }
