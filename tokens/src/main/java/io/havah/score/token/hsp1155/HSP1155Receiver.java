...
/**
 * Smart contracts that want to receive tokens from HSP1155-compatible token contracts
...
public interface HSP1155Receiver {
     ...
     */
    boolean onHSP1155Received(Address _operator, Address _from, BigInteger _id, BigInteger _value, byte[] _data);
     ...
     * @return true if transfer is allowed
     */
    boolean onHSP1155BatchReceived(Address _operator, Address _from, BigInteger[] _ids, BigInteger[] _values, byte[] _data);
}
